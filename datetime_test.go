...
func TestTimeFormatter(t *testing.T) {
	tests := []struct {
		...
		{en, "Monday, January 2, 2006 15:04:05 Mountain Standard Time", time.Date(2025, 1, 2, 12, 30, 0, 0, tzPST), "Thursday, January 2, 2025, 12:30:00\u202FPM Pacific Standard Time"},
		{en, "January 2, 2006 15:04:05 MST", time.Date(2025, 1, 2, 12, 30, 0, 0, tzPST), "January 2, 2025, 12:30:00\u202FPM PST"},
	...
	for _, tt := range tests {
		t.Run(fmt.Sprint(tt.p.LanguageTag, "_", tt.s), func(t *testing.T) {
			test.T(t, tt.p.T(tt.t, tt.layout), tt.s)
		})
	}
}
...
func TestIntervalFormatter(t *testing.T) {
	tests := []struct {
		...
		{en, "Monday, January 2, 2006 15:04:05 Mountain Standard Time", time.Date(2025, 1, 2, 12, 30, 0, 0, tzPST), time.Date(2025, 1, 2, 12, 34, 0, 0, tzPST), "Thursday, January 2, 2025, 12:30:00\u202FPM Pacific Standard Time\u2009–\u200912:34:00\u202FPM Pacific Standard Time"},
		{en, "Monday, January 2, 2006 15:04 Mountain Standard Time", time.Date(2025, 1, 2, 12, 30, 0, 0, tzPST), time.Date(2025, 1, 2, 12, 34, 0, 0, tzPST), "Thursday, January 2, 2025, 12:30\u2009–\u200912:34\u202FPM Pacific Standard Time"},
		{en, "January 2, 2006 15:04:05 MST", time.Date(2025, 1, 2, 12, 30, 0, 0, tzPST), time.Date(2025, 1, 2, 12, 34, 0, 0, tzPST), "January 2, 2025, 12:30:00\u202FPM PST\u2009–\u200912:34:00\u202FPM PST"},
		{en, "January 2, 2006 15:04 MST", time.Date(2025, 1, 2, 12, 30, 0, 0, tzPST), time.Date(2025, 1, 2, 12, 34, 0, 0, tzPST), "January 2, 2025, 12:30\u2009–\u200912:34\u202FPM PST"},
	...
	for _, tt := range tests {
		t.Run(fmt.Sprint(tt.p.LanguageTag, "_", tt.s), func(t *testing.T) {
			test.T(t, tt.p.T(tt.start, tt.end, tt.layout), tt.s)
		})
	}
}
